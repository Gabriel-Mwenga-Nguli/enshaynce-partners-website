...
const certifications = [
    {
        imageSrc: "/images/certificates/tax-compliace-certificate.png",
    ...
    {
        imageSrc: "/images/certificates/hr-practicing-certificate.png",
    ...
    {
        imageSrc: "/images/certificates/hr-firm-registration-certificate.png",
